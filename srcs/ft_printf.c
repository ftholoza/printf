...
/*   Updated: 2023/11/24 15:20:20 by ftholoza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_call_numberf(char c, va_list arg)
{
	size_t	count;
	int		temp;
...
int	ft_call_hexaf(char c, va_list arg)
{
	size_t	count;
	int		temp;
...
int	ft_call_fonction(char c, va_list arg)
{
	size_t	count;
